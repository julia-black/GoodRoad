...
namespace GoodRoadProj.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", "Введён неверный логин или пароль");
            return View(model);
        }
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    db.UserDatas.Add(new UserData(model.UserName));
                    db.SaveChanges();
                    return RedirectToAction("Index", "Home");
                }
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", String.Format("Аккаунт \"{0}\" уже существует", User.Identity.Name));
                    }
                }
            }
